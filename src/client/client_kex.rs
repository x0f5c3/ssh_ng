...
impl Client {
        ...
        S: Read + Write,
    {
        ...
        tracing::info!("start for key negotiation.");
        tracing::info!("send client algorithm list.");
        ...
        tracing::info!("key negotiation successful.");
        ...
        loop {
            ...
            match message_code {
                ssh_msg_code::SSH_MSG_KEXDH_REPLY => {
                    ...
                    if !flag {
                        tracing::error!("signature verification failure.");
                        return Err(SshError::from("signature verification failure."));
                    }
                    tracing::info!("signature verification success.");
                }
